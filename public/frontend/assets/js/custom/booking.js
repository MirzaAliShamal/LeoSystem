(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', ".eventBooking", function () {
            var eventMinDate = $(this).data('event-min-date');
            var eventMaxDate = $(this).data('event-max-date');
            ...
            $('.appendDatePicker').html(' <input type="text" class="eventSelectDate" id="datepicker" autocomplete="off" placeholder="Select Date">\n' +
            '                            <span class="iconify" data-icon="akar-icons:calendar"></span>');
            $("#datepicker").datepicker({
                dateFormat: "dd-mm-yy",
                minDate: new Date(eventMinDate),
                maxDate: new Date(eventMaxDate)
            });
        })
