...
Route::group(['as' => 'student.'], function () {
    ...
    Route::get('become-a-partner', [DashboardController::class, 'becomeAnInstructor'])->name('become-an-instructor');
    Route::get('become-a-partner/submit-your-application', [DashboardController::class, 'showInstructorInfoForm'])->name('show-instructor-info-form');
    ...
    Route::post('save-avatar/{uuid}', [DashboardController::class, 'saveAvatar'])->name('save-avatar');
