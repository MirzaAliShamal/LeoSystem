...
Route::prefix('instructor')->group(function () {
    ...
    Route::get('blocking-history', [InstructorController::class, 'blocking_history'])->name('instructor.blocking-history');
...
Route::prefix('organizations')->as('organizations.')->group(function () {
    ...
    Route::get('blocking-history', [OrganizationController::class, 'blocking_history'])->name('blocking_history');
    ...
    Route::get('approve-organization-status/{uuid}/{status}', [OrganizationController::class, 'changeStatus'])->name('approve-organization');
...
Route::prefix('student')->group(function () {
    ...
    Route::get('blocking-history', [StudentController::class, 'blocking_history'])->name('student.blocking-history');
...
Route::group(['prefix' => 'event', 'as' => 'event.'], function () {
    ...
    Route::post('update/{uuid}', [EventController::class, 'update'])->name('update');

    Route::get('delete/{uuid}', [EventController::class, 'delete'])->name('delete');



    Route::get('event-category-index', [EventCategoryController::class, 'index'])->name('blog-category.index');

    Route::post('event-category-store', [EventCategoryController::class, 'store'])->name('event-category.store');

    Route::patch('event-category-update/{uuid}', [EventCategoryController::class, 'update'])->name('event-category.update');

    Route::get('event-category-delete/{uuid}', [EventCategoryController::class, 'delete'])->name('event-category.delete');
...
Route::prefix('profile')->group(function () {
    ...
    Route::get('/update', [ProfileController::class, 'index'])->name('admin.profile');
...
Route::group(['prefix' => 'menus', 'as' => 'menu.'], function () {
    ...
    // footer Links
    Route::get('footer-info-link-list', [MenuController::class, 'footerLinkList'])->name('footer-Link');
    Route::post('footer-Info-link-list-store', [MenuController::class, 'footerLinkListStore'])->name('footer-Link.store');
    Route::patch('footer-Info-List-update/{id}', [MenuController::class, 'footerLinkListUpdate'])->name('footer-Link.update');
    Route::get('footer-info-linkLists-delete/{id}', [MenuController::class, 'footerLinkListDelete'])->name('footer-Link.delete');
...
Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
    ...
    Route::get('become-teacher-video-section-settings', [HomeSettingController::class, 'becomeInstructorVideoSection'])->name('become-instructor-video-section');

    Route::get('become-student-video-section-settings', [HomeSettingController::class, 'becomeStudentVideoSection'])->name('become-student-video-section');
    ...
    Route::get('vu', [VersionUpdateController::class, 'versionFileUpdate'])->name('file-version-update')->middleware('isDemo');

    Route::post('vu', [VersionUpdateController::class, 'versionFileUpdateStore'])->name('file-version-update-store')->middleware('isDemo');

    Route::get('vu-execute', [VersionUpdateController::class, 'versionUpdateExecute'])->name('file-version-update-execute')->middleware('isDemo');
...
Route::group(['prefix' => 'addon', 'as' => 'admin.addon.'], function () {
    ...
    Route::get('details/{code}', [AddonUpdateController::class, 'addonSaasDetails'])->name('details')->withoutMiddleware(['ai.update']);

    Route::post('store', [AddonUpdateController::class, 'addonSaasFileStore'])->name('store')->withoutMiddleware(['ai.update']);

    Route::post('execute', [AddonUpdateController::class, 'addonSaasFileExecute'])->name('execute')->withoutMiddleware(['ai.update']);

    Route::get('delete/{code}', [AddonUpdateController::class, 'addonSaasFileDelete'])->name('delete')->withoutMiddleware(['ai.update']);
