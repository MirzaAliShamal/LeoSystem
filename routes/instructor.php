...
Route::get('/ls{id}t/{name}/profile', [ProfileController::class, 'profile'])->name('instructor.profile');
Route::post('save-profile/{uuid}', [ProfileController::class, 'saveProfile'])->name('save.profile');
Route::post('save-profile-image/{uuid}', [ProfileController::class, 'saveProfileImage'])->name('save.profile.image');
...
Route::prefix('course')->group(function () {
    ...
    Route::post('edit/{uuid}', [CourseController::class, 'saveCourseImage'])->name('instructor.course.saveImage');
    ...
    Route::prefix('lesson')->group(function () {
        ...
        Route::post('update-lecture-image/{lecture_uuid}', [LessonController::class, 'UpdateLectureImage'])->name('update.lecture.image');
