...
Route::prefix('course')->group(function () {
    ...
    Route::post('save-image/{uuid}', [CourseController::class, 'saveCourseImage'])->name('course.save.image');
...
Route::get('ls{id}or/{name}/profile', [ProfileController::class, 'profile'])->name('profile');
