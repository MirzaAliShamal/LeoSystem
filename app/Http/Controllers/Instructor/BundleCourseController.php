...
//            'image' => 'required|mimes:jpg,png,jpeg,gif,svg',
        ...
        // $bundle->image = $request->image ? $this->saveImage(Auth::user()->id.'/bundle', $request->image, null, null) :   null;
//        $image = $this->uploadFileWithDetails(Auth::user()->id.'/bundle', $request->image);
        $image = $this->saveImageFromBase64(Auth::user()->id.'/bundle', $request->image_base64,$request->width,$request->height);
        $bundle->image = $image;
        $bundle->save();
