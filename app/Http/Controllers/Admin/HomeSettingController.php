...

{
    ...
    public function becomeStudentVideoSection()

    {
        ...
        $data['title'] = 'Become Student Video Section';

        $data['navApplicationSettingParentActiveClass'] = 'mm-active';

        $data['subNavHomeSettingsActiveClass'] = 'mm-active';

        $data['becomeStudentVideoSectionActiveClass'] = 'active';



        return view('admin.application_settings.home.become-student-video-section', $data);
