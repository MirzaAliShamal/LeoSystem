...
class MenuController extends Controller
{
    ...
    {
        $data['title'] = 'Footer Link Lists';
        $data['navMenuParentActiveClass'] = 'mm-active';
        $data['subNavFooterLinkMenuIndexActiveClass'] = 'mm-active';
        $data['menus'] = Menu::where('type', 5)->paginate(25);
        $data['urls'] = Page::all();
        return view('admin.menu.footer-support-link-list', $data);
    }
    public function footerLinkListStore(Request $request)
    {
        $request->validate([
            'name' => 'required|unique:menus,name,NULL,id,type,3',
        ]);
    ...
    public function footerLinkListUpdate(Request $request, $id)
    {
        $request->validate([
            'name' => 'required|unique:menus,name,' . $id . ',id,type,5',
        ]);
    ...
    public function footerLinkListDelete($id)
    {
        Menu::findOrFail($id)->delete();
