...
//            // $image = $this->saveImage(Auth::user()->id.'/course', $request->image, null, null); // new file upload into server
//            $image = $this->uploadFileWithDetails(Auth::user()->id.'/course', $request->image);
//            $image = $image['path'];
//        } else {
//            $image = $course->image;
//        }
