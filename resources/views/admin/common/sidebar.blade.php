<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @endcanany
        @canany(['manage_teacher', 'pending_teacher', 'approved_teacher', 'all_teacher'])
            <li>
                <a class="has-arrow" href="#">
                    <span class="iconify" data-icon="la:chalkboard-teacher"></span>
                    <span>{{ __('Manage Teacher') }}</span>
                </a>
                <ul>
                    @can('pending_teacher')
                    ...
                    @can('teacher_blocked')
                        <li class="{{ active_if_match('admin/instructor/blocked') }}">
                            <a href="{{ route('instructor.blocked') }}">
                                <i class="fa fa-circle"></i>
                                <span>{{ __('Blocked Teacher') }}</span>
                            </a>
                        </li>
                    @endcan

                    @can('teacher_history')
                        <li class="{{ active_if_match('admin/instructor/blocking-history') }}">
                            <a href="{{ route('instructor.blocking-history') }}">
                                <i class="fa fa-circle"></i>
                                <span>{{ __('Blocking History Teacher') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('all_teacher')
        ...
        @canany(['manage_organization', 'pending_organization', 'approved_organization', 'all_organization'])
            <li>
                ...
                <ul>
                    ...
                    @endcan
                    @can('organization_history')
                        <li class="{{ active_if_match('admin/organizations/blocking-history') }}">
                            <a href="{{ route('organizations.blocking_history') }}">
                                <i class="fa fa-circle"></i>
                                <span>{{ __('Blocking History Organizations') }}</span>
                            </a>
                        </li>
                    @endcan
        ...
        @can('manage_student')
            <li class=" {{ active_if_full_match('admin/student') }} ">
                ...
                <ul>
                    ...
                    @can('student_history')
                        <li class="{{ active_if_match('admin/student/blocking-history') }}">
                            <a href="{{ route('student.blocking-history') }}">
                                <i class="fa fa-circle"></i>
                                <span>{{ __('Blocking History Student') }}</span>
                            </a>
                        </li>
                    @endcan
        ...
        <li class="{{ @$navMenuParentActiveClass }}">
            ...
            <ul class="">
                ...
                <li class="{{ @$subNavFooterLinkMenuIndexActiveClass }}">
                    <a href="{{ route('menu.footer-Link') }}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('Footer Info') }}</span>
                    </a>
                </li>
        ...
        @can('manage_event')
            <li class="{{ @$navBlogParentActiveClass }}">
                ...
                <ul>
                    ...
                    <li
                        class="{{ active_if_full_match('admin/event') }} {{ active_if_full_match('admin/blog/edit/*') }}">
                    ...
                    <li class="{{ @$subNavBlogCategoryIndexActiveClass }}">
                        <a href="{{ route('event.blog-category.index') }}">
                            <i class="fa fa-circle"></i>
