                            ...
                            <div class="col-md-6">
                                 ...
                                 <div class="row">
                                        ...
                                        <div class="col-md-10 mb-25">  
                                            <input type="text" name="phone_number" id="phone_number" value="{{ $organization->phone_number }}" class="form-control"  placeholder="Type your phone number"> 
...
<script>
     function selectCountryForPhone(countryCode) {
        ...
        var phone = "+{{ $organization->user->area_code.$organization->phone_number }}"; 
        iti.setNumber(phone);
