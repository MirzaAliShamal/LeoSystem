                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{__('All Organization')}}</li>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('organizations.view', [$organization->uuid]) }}">
                                                @if ($organization->user && $organization->user->image_path)
                                                    @php
                                                        $file_path = public_path($organization->user->image);
                                                    @endphp

                                                    @if (file_exists($file_path))
                                                        <!-- Show image from the first path -->
                                                        <img
                                                            src="{{ asset($organization->user->image_path) }}"
                                                            width="80" style="border-radius: 18px;" alt="img">
                                                    @else
                                                        <!-- Neither path exists, show a placeholder or handle it as needed -->
                                                    <img
                                                        src="{{ asset(REG_DEFAULT_ORGANIZATION) }}"
                                                        width="80" style="border-radius: 18px;" alt="img">
                                                    @endif
                                                @else
                                                    <img
                                        ...
                                        <td>
                                            ...
                                            <select name="auto_content_approval"
                                                ...
                                                <option value="1"
                                                        @if($organization->auto_content_approval == 1) selected @endif>{{ __('Enable') }}</option>

                                                <option value="0"
                                                        @if($organization->auto_content_approval == 0) selected @endif>{{ __('Disable') }}</option>
                                        ...
                                        <td>
                                            ...
                                            <select name="status"
                                                ...
                                                <option value="1"
                                                        @if($organization->status == 1) selected @endif>{{ __('Approved') }}</option>

                                                <option value="2"
                                                        @if($organization->status == 2) selected @endif>{{ __('Blocked') }}</option>

                                                <option value="0"
                                                        @if($organization->status == 0) selected @endif>{{ __('Pending') }}</option>
                                        ...
                                        <td>
                                            ...
                                            <div class="action__buttons">
                                                ...
                                                <a href="{{route('organizations.view', [$organization->uuid])}}"
                                                   class="btn-action mr-30" title="View">
                                                ...
                                                <a href="{{route('organizations.edit', [$organization->uuid])}}"
                                                   class="btn-action mr-30" title="Edit">
