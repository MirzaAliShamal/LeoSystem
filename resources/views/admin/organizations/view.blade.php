                        ...
                        <ul class="profile__item__list">
                            ...
                            <li>
                                ...
                                <div class="list-item">
                                    ...
                                    <h2>{{__('Organization ID')}}:</h2>

                                    <p>&nbsp;&nbsp;LS{{$organization->user->id}}OR</p>
                            ...
                            <li>
                                ...
                                <div class="list-item">
                                    ...
                                    <h2>{{__('Full Organization Name')}}:</h2>

                                    <p>&nbsp;&nbsp;{{$organization->full_organization_name}}</p>
                            ...
                            <li>
                                ...
                                <div class="list-item">
                                    ...
                                    <h2>{{__('Official Identification Number')}}:</h2>

                                    <p>&nbsp;&nbsp;{{$organization->official_id_number}}</p>
                            ...
                            <li>
                                ...
                                <div class="list-item">
                                    ...
                                    <p>&nbsp;&nbsp;{{$organization->number_of_teachers}}</p>
                            ...
                            <li>
                                ...
                                <div class="list-item">
                                    ...
                                    <p>+({{$organization->user->area_code}}) {{$organization->phone_number}}</p>
