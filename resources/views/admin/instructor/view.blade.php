                        ...
                        <div class="breadcrumb__content__right">
                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('instructor.index')}}">{{__('All Teachers')}}</a></li>

                                    <li class="breadcrumb-item active" aria-current="page">{{__('Teacher Profile')}}</li>
                        ...
                        <ul class="profile__item__list">
                            ...
                            <li>
                                ...
                                <div class="list-item">
                                    ...
                                    <p>+({{ $instructor->user->area_code }}) {{$instructor->phone_number}}</p>
