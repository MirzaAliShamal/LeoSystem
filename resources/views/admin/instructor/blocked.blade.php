                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{__('Blocked Teachers')}}</li>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('instructor.view', [$instructor->uuid])}}"> <img
                                                    src="{{ $instructor->user && file_exists(public_path($instructor->user->image_path)) ? getImageFile($instructor->user ? $instructor->user->image_path : '') : asset('uploads/default/reg-default-teacher.jpg')}}"
                                                    width="80"> </a>
