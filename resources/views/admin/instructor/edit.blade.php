                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-10 mb-25">  
                                            <input type="text" name="phone_number" id="phone_number" value="{{ $instructor->phone_number }}" class="form-control"  placeholder="Type your phone number"> 
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input__group mb-25">
                                    ...
                                    <label>{{ __('About Teacher') }} <span class="text-danger">*</span></label>
...
<script>
     function selectCountryForPhone(countryCode) {
        ...
        var phone = "+{{ $instructor->user->area_code.$instructor->phone_number }}"; 
        iti.setNumber(phone);
