                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{__('Approved Teachers')}}</li>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('instructor.view', [$instructor->uuid])}}"> <img
                                                    src="{{ $instructor->user?->image && file_exists(public_path($instructor->user->image_path)) ?  asset($instructor->user->image_path) : asset(REG_DEFAULT_TEACHER)}}"
