                ...
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        <div class="item-title d-flex justify-content-between">
                            <h2>{{ __('Footer Info Menu Lists') }}</h2>
                                        ...
                                        <tr class="removable-item">
                                            ...
                                            <td>
                                                <div class="action__buttons">
                                                    <a class=" btn-action mr-1 edit" data-item="{{ $menu }}"
                                                        data-updateurl="{{ route('menu.footer-Link.update', @$menu->id) }}"
                                                        data-toggle="tooltip" title="Edit">
                                                        <img src="{{ asset('admin/images/icons/edit-2.svg') }}"
                                                            alt="edit">
                                                    </a>
                                                    <a href="javascript:void(0);"
                                                        data-url="{{ route('menu.footer-Link.delete', [$menu->id]) }}"
    ...
    <div class="modal fade" id="add-todo-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('menu.footer-Link.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="url" id="url" placeholder="{{ __('Type Url') }}"
                                value="" required>
                            @if ($errors->has('url'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
