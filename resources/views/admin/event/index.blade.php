                                    ...
                                    <tr class="removable-item">
                                        <td>
                                            <div class="admin-dashboard-blog-list-img">
                                                <img src="{{getImageFile($event->main_image)}}" alt="img">
                                            </div>
                                        </td>
                                        <td>
                                            {{$event->title}}
                                        ...
                                        <td>
                                            @if($event->event_status == 1)
                                                <span class="status bg-green">{{ __('Active Event') }}</span>
                                            @elseif($event->event_status == 2)
                                                <span class="status bg-red">{{ __('Past Event') }}</span>
                                            @elseif($event->event_status == 3)
                                                <span class="status bg-yellow">{{ __('Future Event') }}</span>
                                            @endif
                                        </td>
