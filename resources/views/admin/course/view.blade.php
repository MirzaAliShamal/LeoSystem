...
<div class="page-content">
    <div class="container-fluid">
        ...
        @if($course->course_type == COURSE_TYPE_GENERAL || $course->course_type == COURSE_TYPE_SCORM || $course->course_type == COURSE_TYPE_LIVE_CLASS)
        <div class="row">
            <div class="col-md-12">
                                            ...
                                            <div class="play-list">
                                                ...
                                                @if($course->course_type == COURSE_TYPE_GENERAL)
                                                    ...
                                                    <a class="edit-lecture-preview-show d-flex align-items-center justify-content-between color-heading font-medium font-16 mb-3"
                                                        ...
                                                        <div class="upload-course-video-6-text flex-shrink-0">
                                                            <span
                                                                class="see-preview-video font-medium font-16">SCORM</span>
                                                            <span class="video-time-count">{{ $lecture->file_duration
                                                                }}</span>
                                                        </div>
                                                    </a>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="customers__area bg-style mb-30">
                                                                                ...
                                                                                <div class="admin-course-watch-page-area">
                                                                                    ...
                                                                                    <iframe id="scorm_player" class="scorm-content" frameBorder="0" src="{{ asset("uploads/".$course->scorm_course->uuid.'/'.$course->scorm_course->entry_url) }}"
