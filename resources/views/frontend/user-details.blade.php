                    ...
                    <div class="instructor-details-right-content radius-3">
                        <div class="course-info-box instructor-info-box bg-white p-0">
                            ...
                            <div class="instructor-details-right-img-box text-center mb-20">
                                ...
                                <img src="{{ $user->getAvatarUrl($user->is_organization() ? 'organization' : 'teacher') }}" alt="User Image" class="avater-imag">
                                </div>
                            @if($user->role == USER_ROLE_INSTRUCTOR)
                                <br>
                                <p class="instructor-details-designation font-12 font-semi-bold mb-15" style="margin: 0px;"><b>Teacher ID: </b> LS{{
                                    $user->id }}T</p>
                            ...
                            @elseif($user->role == USER_ROLE_ORGANIZATION)
                                <p class="instructor-details-designation font-12 font-semi-bold mb-15" style="margin: 0px;">Organization ID: LS{{
                                    $user->id }}OR</p>
                                <h6 class="instructor-details-name" style="padding: 10px 0 0px;">{{ $user->$userRelation->full_organization_name }}</h6>
                                <hr />
                                <p class="instructor-details-designation font-12 font-semi-bold mb-15">Administrator: {{
                                    $user->$userRelation->name }}</p>
                                <hr />
                                <p class="instructor-details-designation font-12 font-semi-bold mb-15">{{
                                    $user->$userRelation->professional_title }}</p>
                            @endif
