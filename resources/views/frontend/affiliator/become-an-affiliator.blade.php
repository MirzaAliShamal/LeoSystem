                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-10">
                        <div class="affiliator-dashboard-wrap bg-white">
                            <div
                                class="affiliator-dashboard-title d-flex align-items-center justify-content-between  mb-30 pb-20">
                                <h5>{{ __('Affilaiator Application Form') }}</h5>
                            </div>

                            <form enctype="multipart/form-data" action="{{ route('affiliate.create-affiliate-request') }}"
                                method="post">
                                @csrf
                                <div class="row mb-30">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" value="{{ Auth::user()->name }}" readonly
                                            ...
                                            placeholder="{{ __('Write your first name') }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-30">
                                    <div class="col-md-12">
                                        <label
                                            class="label-text-title color-heading font-medium font-16 mb-2">{{ __('Email address') }}</label>
                                        <input type="email" name="email" value="{{ Auth::user()->email }}" readonly
                                            class="form-control" id="email_address"
                                            placeholder="{{ __('Write your email') }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-30">
                                    <div class="col-md-12">
                                        <label
                                            class="label-text-title color-heading font-medium font-16 mb-2">{{ __('Address') }}</label>
                                ...
                                <div class="row mb-30">
                                    <div class="col-md-12">
                                        <label
                                            class="label-text-title color-heading font-medium font-16 mb-2">{{ __('Cover Letter') }}</label>
                                        <textarea name="letter" class="form-control" cols="30" rows="5" placeholder="{{ __('Your message') }}"
                                            required=""></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <button type="submit"
                                        class="theme-btn theme-button1 default-hover-btn">{{ __('Apply Now') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
