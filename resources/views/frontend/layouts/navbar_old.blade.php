                ...
                <div class="header-nav-right-side d-flex">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{route('student.become-an-instructor')}}">{{__('Become a
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('blogs') }}">{{__('Events')}}</a>
                        ...
                        <li class="nav-item dropdown menu-round-btn menu-user-btn dropdown-top-space">
                            ...
                            <div class="dropdown-menu {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end'}}"
                                ...
                                <ul class="user-dropdown-item-box">
                                    @if(\Illuminate\Support\Str::contains(url()->current(), 'organization/dashboard') || \Illuminate\Support\Str::contains(url()->current(), 'instructor/dashboard'))
                                    <li><a class="dropdown-item" href="{{route('student.dashboard')}}"><span

                                            class="iconify" data-icon="tabler:affiliate"></span>{{__('Student Panel')}}

                                    </a></li>
                                    @elseif(@$authUser->role == USER_ROLE_STUDENT)
                                        <li><a class="dropdown-item" href="{{route('student.become-an-instructor')}}"><span

                                                class="iconify" data-icon="tabler:affiliate"></span>{{__('Become a Partner')}}

                                        </a></li>
                                        
                                    @elseif(@$authUser->role == USER_ROLE_INSTRUCTOR)
                                        <li><a class="dropdown-item" href="{{route('instructor.dashboard')}}"><span

                                                class="iconify" data-icon="tabler:affiliate"></span>{{__('Teacher Panel')}}

                                        </a></li>
                                    @elseif(@$authUser->role == USER_ROLE_ORGANIZATION)
                                        <li><a class="dropdown-item" href="{{route('organization.dashboard')}}"><span

                                                class="iconify" data-icon="tabler:affiliate"></span>{{__('Organization Panel')}}
                        ...
                        <li class="nav-item  menu-sign-in-btn">
                            ...
                            <a href="{{ route('login') }}" class="nav-link theme-button1" aria-current="page">{{__('Log In')}}</a>

                        </li>
                       
                        <li class="nav-item  menu-sign-up-btn ml-2">

                            <a href="{{ url('sign-up') }}" class="nav-link theme-button1" aria-current="page">{{__('Sign Up')}}</a>
