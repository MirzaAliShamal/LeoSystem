            ...
            <div class="row footer-top-part section-p-t-b-90">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="footer-widget footer-contact-info">
                        ...
                        <div class="footer-links d-flex">
                            <ul>
                                @foreach ($footerEndMenus ?? [] as $footerEndMenu)
                                    <li><a href="{{ $footerEndMenu->url }}">{{ __($footerEndMenu->name) }}</a>
                                    </li>
                                @endforeach
            ...
            <div class="row copyright-wrapper ">
                <div class="col-12 col-md-12 col-lg-4 ">
                    <div class="footer-payment">
                        <img src="{{ asset(get_option('app_footer_payment_image') ?? 'frontend/assets/img/footer-left-picture.png') }}"
                            alt="payments">
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
                ...
                <div class="col-12 col-md-12 col-lg-4 text-end">
                    <div class="footer-payment">
                        <img src="{{ asset(get_option('app_footer_payment_image') ?? 'frontend/assets/img/footer-right-picture.png') }}"
                            alt="payments">
                    </div>
                </div>
                {{-- <div class="col-12 col-md-12 col-lg-4">
