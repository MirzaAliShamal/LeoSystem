                    ...
                    <ul class="navbar-nav">
                        ...
                        @if (Route::has('login'))
                            ...
                            @auth
                                ...
                                @php
                                    $userId = auth()->id();
                                    $imagePath = "uploads/{$userId}/user/" . auth()->user()->image;
                                    $filePath = public_path($imagePath);
                                    $fileExists = file_exists($filePath);

                                    if(@$authUser->role == USER_ROLE_INSTRUCTOR)
                                    {
                                        $default_img = asset('/uploads/default/reg-default-teacher.jpg');
                                    } elseif(@$authUser->role == USER_ROLE_ORGANIZATION)
                                    {
                                        $default_img = asset('/uploads/default/reg-default-organization.jpg');
                                    }else{
                                        $default_img = asset('/uploads/default/reg-default-student.jpg');
                                    }
                                @endphp
                                ...
                                <li class="nav-item dropdown menu-round-btn menu-user-btn dropdown-top-space">
                                    ...
                                    <a class="nav-link" href="#">
                                        ...
                                        <img src="{{ $fileExists && auth()->user()->image ? asset($imagePath) : $default_img }}"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            ...
                                                            <div class="user-img-wrap position-relative radius-50">
                                                                ...
                                                                <img src="{{ $fileExists && auth()->user()->image ? asset($imagePath) : $default_img }}"
                                                                     id="user-profile-logo" alt="img"
                                                                     class="radius-50 user-profile-logo">
                                                    ...
                                                    @if(@$authUser->role == USER_ROLE_STUDENT )
                                                        ...
                                                        @if(@$authUser->instructor || @$authUser->organization)
                                                            ...
                                                            <li>
                                                                ...
                                                                <span class="dropdown-item"><span class="iconify"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                       href="{{route('instructor.dashboard')}}"><span
                                                                                class="iconify"
                                                                                data-icon="tabler:affiliate"></span> {{__('Instructor Panel')}}
                                                                    </a>
...
{{--                                                                    <a class="dropdown-item"--}}
{{--                                                                       href="{{route('student.dashboard')}}"><span--}}
{{--                                                                                class="iconify"--}}
{{--                                                                                data-icon="tabler:affiliate"></span> {{__('Student Panel')}}--}}
{{--                                                                    </a>--}}
...
{{--                                                            @endif--}}
                                                        ...
                                                        @elseif(@$authUser->instructor->status == STATUS_REJECTED)
                                                            ...
                                                            <li>
                                                                ...
                                                                <span class="dropdown-item"><span class="iconify"
                                                                                                  data-icon="tabler:affiliate"></span> {{__('Blocked From Instructor Panel')}}</span>
                                                        ...
                                                        @elseif(@$authUser->organization->status == STATUS_REJECTED)
                                                            ...
                                                            <li>
                                                                ...
                                                                <span class="dropdown-item"><span class="iconify"
                                                                                                  data-icon="tabler:affiliate"></span> {{__('Blocked From Organization Panel')}}</span>
                                            ...
                                            <ul class="user-dropdown-item-box">
                                                ...
                                                <li>
                                                    ...
                                                    @elseif(@$authUser->role == USER_ROLE_INSTRUCTOR)
                                                        <a class="dropdown-item"
                                                           href="{{ route('instructor.profile') }}"><span
                                                    ...
                                                    @else
                                                        <a class="dropdown-item"
                                                           href="{{ route('organization.profile') }}"><span
