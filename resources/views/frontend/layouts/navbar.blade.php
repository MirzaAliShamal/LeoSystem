                            ...
                            <ul class="dropdown-menu {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-end' : ''}}">
                                ...
                                @foreach($categories as $category)
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('category-courses', strtolower($category->slug)) }}"
                                            ...
                                            <ul class="submenu dropdown-menu">
                                                ...
                                                @foreach($category->subcategories as $subcategory)
                                                    ...
                                                    <li><a class="dropdown-item"
                                                           ...
                                                           href="{{ route('subcategory-courses', strtolower($subcategory->slug)) }}">{{
                    ...
                    <form action="#">
                        ...
                        <div class="input-group">
                            ...
                            <button class="input-group-text pe-0" id="basic-addon1"><img
                                    ...
                                    src="{{ asset('frontend/assets/img/icons-svg/search.svg') }}" alt="Search">
                            </button>
                ...
                <div class="header-nav-right-side d-flex">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ url('/teachers') }}">{{__('Teachers')}}</a>
                                        ...
                                        <ul class="nav nav-pills menu-notification-tab-list" id="pills-tab"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                ...
                                                <button class="nav-link " id="pills-instructor-tab"
                                                        ...
                                                        aria-selected="true">{{__('Teacher')}}</button>
                        ...
                        @if (Route::has('login'))
                            ...
                            @auth
                                ...
                                @php
                                    ...
                                    $studentImage = public_path(auth()->user()->student?->image);
                                ...
                                <li class="nav-item dropdown menu-round-btn menu-user-btn dropdown-top-space">
                                    <a class="nav-link" href="#">
                                        ...
                                        @if(\Illuminate\Support\Str::startsWith(url()->current(),[url('student'),url('common'),url('support-ticket')]))
                                            <!-- STUDENT IMAGE-->
                                            <img src="{{ auth()->user()->getAvatarUrl('student') }}"
                                                 alt="user" class="radius-50">

                                        @elseif(!\Illuminate\Support\Str::contains(url()->current(),['instructor','organization']))
                                            <!-- STUDENT IMAGE-->
                                            <img src="{{ auth()->user()->getAvatarUrl('student') }}"
                                                 alt="user" class="radius-50">
                                        @elseif(
                                            !\Illuminate\Support\Str::startsWith(url()->current(),
                                            [
                                                url('student'),
                                                url('common'),
                                                url('support-ticket')
                                            ],
                                            ) && (auth()->user()->role == USER_ROLE_INSTRUCTOR ||  auth()->user()->role == USER_ROLE_ORGANIZATION))
                                            <img src="{{ auth()->user()->getAvatarUrl('teacher')  }}"
                                                 alt="user" class="radius-50">
                                    ...
                                    <div
                                        class="dropdown-menu default-border {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end'}}"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            ...
                                                            <div class="user-img-wrap position-relative radius-50">
                                                                ...
                                                                @if(\Illuminate\Support\Str::startsWith(url()->current(), [url('student'),url('common'),url('support-ticket')]))
                                                                    <img
                                                                        src="{{ auth()->user()->getAvatarUrl('student') }}"
                                                                        alt="user" class="radius-50">
                                                                @elseif(!\Illuminate\Support\Str::contains(url()->current(),['teacher','organization']))
                                                                    <img
                                                                        src="{{ auth()->user()->getAvatarUrl('student') }}"
                                                                        alt="user" class="radius-50">
                                                                @elseif(!\Illuminate\Support\Str::startsWith(url()->current(), [url('student'),url('common'),url('support-ticket')]) && (auth()->user()->role == USER_ROLE_INSTRUCTOR || auth()->user()->role == USER_ROLE_ORGANIZATION))
                                                                    <img
                                                                        src="{{ auth()->user()->getAvatarUrl('teacher') }}"
                                                                        alt="user" class="radius-50">
                                                                @else
                                                                    <img
                                                                        src="{{ auth()->user()->getAvatarUrl('student') }}"
                                                    ...
                                                    @if(@$authUser->role == USER_ROLE_STUDENT )
                                                        ...
                                                        @if(@$authUser->instructor || @$authUser->organization)
                                                            ...
                                                            <li>
                                                                ...
                                                                <span class="dropdown-item default-border"><span class="iconify"
                                                                                                  data-icon="tabler:affiliate"></span> {{__('Request Pending')}}</span>
                                                        ...
                                                        @else
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('student.become-an-instructor')}}"><span
                                                                        class="iconify"
                                                                        data-icon="tabler:affiliate"></span> {{__('Become a
                                        ...
                                        Partner')}}</a>
                                                    ...
                                                    @elseif(@$authUser->role == USER_ROLE_INSTRUCTOR || @$authUser->role == USER_ROLE_ORGANIZATION)
                                                        ...
                                                        @if(@$authUser->instructor->status == STATUS_APPROVED)
                                                            ...
                                                            @if(\Illuminate\Support\Str::contains(url()->current(), 'teacher'))

                                                                <li>

{{--                                                                    <a class="dropdown-item {{ $authUser->student->status === STATUS_REJECTED ? 'text-danger' : '' }}"--}}
{{--                                                                       href="{{ $authUser->student->status === STATUS_REJECTED ? '#' :route('student.profile')}}"><span--}}
{{--                                                                            class="iconify"--}}
{{--                                                                            data-icon="tabler:affiliate"></span> {{__('Student Panel '). ($authUser->student->status === STATUS_REJECTED ? 'Locked' : '') }}--}}
{{--                                                                    </a>--}}

                                                                    @if($authUser->student->status === STATUS_REJECTED)
                                                                        <div class="dropdown-item default-border text-danger">
                                                                            <span class="iconify"
                                                                                  data-icon="tabler:affiliate">
                                                                            </span> {{__('Student Panel') . ' Locked' }}
                                                                        </div>
                                                                    @else
                                                                        <a class="dropdown-item"
                                                            ...
                                                            @else
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                       href="{{route('instructor.dashboard')}}"><span
                                                                            class="iconify"
                                                                            data-icon="tabler:affiliate"></span> {{__('Teacher Panel')}}
                                                                    </a>
                                                        ...
                                                        @elseif(@$authUser->organization->status == STATUS_APPROVED)
                                                            ...
                                                            @else
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                       href="{{route('organization.dashboard')}}"><span
                                                                            class="iconify"
                                                                            data-icon="tabler:affiliate"></span> {{__('Organization Panel')}}
                                                                    </a>
                                                        ...
                                                        @elseif(@$authUser->instructor->status == STATUS_REJECTED)
                                                            ...
                                                            <li>
                                                                ...
                                                                <span class="dropdown-item default-border text-danger"
                                                                      style="color: #d20921;">
                                                                    <span class="iconify"
                                                                          data-icon="tabler:affiliate">
                                                                    </span>
                                                                    {{ __('Teacher Panel Locked') }}</span>
                                                        ...
                                                        @elseif(@$authUser->organization->status == STATUS_REJECTED)
                                                            ...
                                                            <li>
                                                                ...
                                                                <span class="dropdown-item default-border text-danger">
                                                                    ...
                                                                    {{__('Organization Panel Locked')}}</span>
                                            ...
                                            @if(@$authUser->student->status === STATUS_APPROVED)
                                                <ul class="user-dropdown-item-box">
                                                ...
                                                <ul class="user-dropdown-item-box">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="dropdown-item"
                                                           href="{{ route('student.profile') }}"><span
...
{{--                                            @if(@$authUser->instructor->status == STATUS_REJECTED)--}}
                                                ...
                                                get_option('referral_status') == 1)
                                                    ...
                                                    <ul class="user-dropdown-item-box">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a class="dropdown-item default-border" href="#"><span class="iconify"
                            ...
                            @else
                                ...
                                <li class="nav-item  menu-sign-in-btn">
                                    ...
                                    <a href="{{ route('login') }}" class="nav-link theme-button1"
                                       aria-current="page">{{__('Log In')}}</a>

                                </li>

                                <li class="nav-item  menu-sign-up-btn ml-2">

                                    <a href="{{ url('sign-up') }}" class="nav-link theme-button1"
                                ...
                                @if (Route::has('register'))
                                    ...
                                    <li class="nav-item  menu-sign-up-btn">
