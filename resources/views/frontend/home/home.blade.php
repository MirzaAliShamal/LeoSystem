...
@section('content')
                    ...
                    <div class="col-12 col-md-7 col-lg-5">
                        ...
                        <div class="hero-content position-relative">
                            ...
                            <a class="video-btn" href="#"
                                onclick="document.getElementsByTagName('body')[0].style = 'padding-right: 0px;overflow: hidden;'"
                                data-bs-toggle="modal" data-bs-target="#myModal"><img class="hero-video-icon"
                                    src="{{ asset('frontend/assets/img/1.png') }}" alt="" /></a>
    ...
    <section class="special-feature-area p-0 {{ @$home->special_feature_area == 1 ? '' : 'd-none' }}">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-feature-item align-items-center">
                        <div class="row g-0">
                            <div class="col-lg-5 col-md-12">
                                <div class="feature-img-wrap">
                                    <img class="img-fit"
                                        src="{{ getImageFile(get_option('home_special_feature_first_logo')) }}"
                                        alt="feature">
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-12">
                                <div class="ms-3 feature-content">
                    ...
                    <div class="single-feature-item align-items-center">
                        <div class="row g-0">
                            <div class="col-lg-5 col-md-12">
                                <div class="feature-img-wrap">
                                    <img class="img-fit"
                                        src="{{ getImageFile(get_option('home_special_feature_second_logo')) }}"
                                        alt="feature">
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-12">
                    ...
                    <div class="single-feature-item align-items-center">
                        <div class="row g-0">
                            <div class="col-lg-5 col-md-12">
                                <div class="feature-img-wrap">
                                    <img class="img-fit"
                                        src="{{ getImageFile(get_option('home_special_feature_third_logo')) }}"
                                        alt="feature">
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-12">
                                                    ...
                                                    <p class="card-text instructor-name-certificate font-medium font-12">
                                                        ...
                                                        <a
                                                            href="{{ route('userProfile', [
                                                                'roles' => $bundle->user->is_organization() ? 'organizations' : 'teachers',
                                                                'user' => $bundle->user->id,
                                                                'type' => $bundle->user->is_organization() ? 'or' : 't',
                                                                'name' => $bundle->user->is_organization() ? $bundle->user->organization->full_organization_name_slug : $bundle->user->instructor->full_instructor_name_slug
                                                                ]) }}">{{ @$bundle->user->$relation->name }}</a>
                        ...
                        @foreach (@$firstFourCategories as $firstFourCategory)
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                ...
                                <div class="single-feature-item top-cat-item align-items-center">
                                    ...
                                    <div class="flex-grow-1 mt-3 feature-content" style="height: 78px;">
                    ...
                    <div class="col-12">
                        ...
                        <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                            ...
                            <div class="course-tab-nav-wrap d-flex justify-content-between">
                                ...
                                <ul class="nav nav-tabs tab-nav-list border-0" id="Tab5" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                            onclick="TextChange('Organization')" data-bs-target="#pills-home"
                                            type="button" role="tab" aria-controls="pills-home"
                                            aria-selected="true">Organization</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-profile-tab"
                                            data-bs-toggle="pill"onclick="TextChange('Teachers')"
                                            data-bs-target="#pills-profile" type="button" role="tab"
                                            aria-controls="pills-profile" aria-selected="false">Teachers</button>
                                    </li>
                                </ul>
                            ...
                            <a href="{{ route('instructor') }}" id="instructor-link"
                                class="theme-btn theme-button2 theme-button3">{{ __('View All Teachers') }} <i
                                    data-feather="arrow-right"></i></a>
                    ...
                    <div class="tab-content" id="Tab5-content">
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <div class="col-12 w-100">
                                <div class="course-slider-items one-to-one-slider-items owl-carousel owl-theme">
                                    @forelse($organizations as $instructorUser)
                                        <!-- Single Instructor Item start-->
                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-12 mt-0 mb-25">
                                    ...
                                    @empty
                                        <div class="no-course-found text-center">
                                            <img src="{{ asset('frontend/assets/img/empty-data-img.png') }}"
    ...
    @if ($home->video_area == 1)
        ...
        <section class="video-area desktop-student">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="video-area-right position-relative">
                            ...
                            <div class="section-title">
                                ...
                                <h3 class="section-heading">
                                    {{ Str::limit(__(get_option('become_student_video_title')), 100) }}</h3>

                            </div>



                            <div class="video-floating-img-wrap student pe-2 position-relative">

                                <p>{{ Str::limit(get_option('become_student_video_subtitle'), 450) }}</p>

                                <img src="{{ getImageFile(get_option('become_student_video_logo')) }}" alt="video"
                            ...
                            <div class="col-12 section-btn">
                                ...
                                <a href="{{ url('/sign-up') }}"
                                    class="theme-btn theme-button1">{{ __('Become a Student') }} <i
                                        data-feather="arrow-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-7 col-xl-8">
                        ...
                        <div class="video-area-left position-relative d-flex align-items-center justify-content-center">
                            ...
                            <img src="{{ getImageFile(get_option('become_student_video_preview_image')) }}"
        ...
        <section class="video-area tab-phone-student mb-5">
                        ...
                        <div class="video-area-right position-relative">
                            ...
                            <div class="col-12 section-btn">
                                ...
                                <a href="{{ route('student.become-an-instructor') }}"
                                    class="theme-btn theme-button1">{{ __('Become an student') }} <i
                                        data-feather="arrow-right"></i></a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-lg-7 col-xl-8">
                        ...
                        <div class="video-area-left position-relative d-flex align-items-center justify-content-center">
                            ...
                            <button type="button" class="play-btn position-absolute" data-bs-toggle="modal"
                                data-bs-target="#BecomeAnInstructerVedio">
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4">
                        ...
                        <div class="video-area-right position-relative">
                            ...
                            <div class="col-12 section-btn">
                                ...
                                <a href="{{ route('student.become-an-instructor') }}"
                                    class="theme-btn theme-button1">{{ __('Become an Teacher') }} <i
                                        data-feather="arrow-right"></i></a>
 ...
 <div class="modal fade VideoTypeModal" id="BecomeAnInstructerVedio" tabindex="-1" aria-labelledby="newVideoPlayerModal"
 aria-hidden="true">
 ...
 <div class="modal-header border-bottom-0">
     ...
     <button type="button" class="btn-close closePlayer" data-bs-dismiss="modal" aria-label="Close"><span
...
<!-- New Video Player Modal End-->
    ...
    <div class="modal fade VideoTypeModal" id="newVideoPlayerModal" tabindex="-1" aria-labelledby="newVideoPlayerModal"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
<div class="modal-header">{{get_option('become_student_video')}}</div>
                <div class="modal-body">
                    ...
                    <div class="video-player-area">
                        ...
                        <video id="player" playsinline controls
                            data-poster="{{ getImageFile(get_option('become_student_video_preview_image')) }}"
                            controlsList="nodownload">

                            <source src="{{ getVideoFile(get_option('become_student_video')) }}" type="video/mp4"
                                style="border-radius:10px">
    ...
    <div class="modal fade VideoTypeModal" id="myModal" tabindex="-1" aria-labelledby="newVideoPlayerModal"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="video-player-area">
                        ...
                        <video id="player2" playsinline controls
                            data-poster="{{ asset('frontend/assets/videos/image-main-page.jpg') }}"
                            controlsList="nodownload">

                            <source src="{{ asset('frontend/assets/videos/video-main-page.mp4') }}" type="video/mp4">
...
@push('script')
    ...
    <script>
        const sm_player = new Plyr('#player');

        const sm_player2 = new Plyr('#player2');
        const sm_player3 = new Plyr('#player3');
        $('.closePlayer').on('click', function() {
            var video = $('#player2').get(0);
            var video2 = $('#player').get(0);
            var video3 = $('#player3').get(0);
            if (video) {
                console.log('Pausing vedio 1');
                video.pause();
            }
            if (video2) {
                console.log('Pausing video2');
                video2.pause();
            }
            if (video3) {
                console.log('Pausing video3');
                video3.pause();
            }
        });

        const modal1Element = document.getElementById('newVideoPlayerModal');
        const modal2Element = document.getElementById('myModal');
        const modal3Element = document.getElementById('BecomeAnInstructerVedio');
        ...
        // Function to handle closing modal on PiP enter and opening modal on PiP leave
        function handlePiPEvents(playerInstance, modalElement, modalInstance) {
            playerInstance.on('enterpictureinpicture', () => {
                modalInstance.hide();
                video3.play();
                video2.play();
                video.play();
            ...
            playerInstance.on('leavepictureinpicture', () => {
                modalInstance.hide();
                playerInstance.pause()
            });

            modalElement.addEventListener('shown.bs.modal', () => {
                playerInstance.play(); // Play the video when the modal is shown again
            });
            modalElement.addEventListener('hidden.bs.modal', () => {
            playerInstance.pause(); // Pause the video when the modal is hidden
        });
        }

        // Apply the function to both players and modals
        handlePiPEvents(sm_player, modal1Element, modal1);
        handlePiPEvents(sm_player2, modal2Element, modal2);
        handlePiPEvents(sm_player3, modal3Element, modal3);
        ...
        function TextChange(tabname) {
            var linkElement = $('#instructor-link');
            // console.log(tabname);
            var check = tabname;
            if (check == 'Teachers') {
                newText = "View All Teachers";
                newHref = "{{ route('instructor') }}";

            } else if (check == 'Organization') {
                newText = "View All Organizations";
                newHref = "{{ url('/organizations') }} ";
            } else {
                console.log('nothing');
            }
