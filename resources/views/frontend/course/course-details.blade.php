...
<section class="course-single-details-area before-login-purchase-course-details">
    ...
    $userId = auth()->id();
    $imagePath = "uploads/{$userId}/course/{$course->image}";
...
@else
                                <img src="{{ getImageFile($course->image) }}" alt="video" class="img-fluid">
                    @endif            
                                </div>
                        ...
                        <div class="course-includes-box mb-30">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <span>{{ @$TotalScormCount}} {{ __('SCORM') }}</span>
                                </li>
                                <li>
...
<div class="modal fade VideoTypeModal" id="newVideoPlayerModal" tabindex="-1" aria-labelledby="newVideoPlayerModal" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 33px !important;">
            <div class="modal-body p-1">
...
@push('script')
    ...
    <script>
        ...
        // const sm_player2 = new Plyr('#youtubePlayer');
        const sm_player1 = new Plyr('#player2');
        const sm_player3 = new Plyr('#youtubePlayer2');
        // const sm_player4 = new Plyr('#vimeoPlayer');
    </script>
