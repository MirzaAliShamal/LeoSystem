                                ...
                                @forelse($lesson->lectures as  $lecture)
                                    ...
                                    @if($lecture->lecture_type == 1)
                                        ...
                                        @if($lecture->type == 'video')
                                            ...
                                            @elseif($lecture->type == 'scrom')
                                            
                                            <a class="edit-lecture-preview-show d-flex align-items-center justify-content-between color-heading font-medium font-16 mb-3" data-bs-toggle="modal" href="#newScromPlayerModal{{ $lecture->id }}">
                                                <div class="d-flex flex-grow-1">
                                                    <div><img src="{{ asset('frontend/assets/img/courses-img/play.svg') }}" alt="play"></div>
                                                    <div class="font-medium font-16 lecture-edit-title">{{$lecture->title}}</div>
                                                </div>
                                                ...
                                                <div class="upload-course-video-6-text flex-shrink-0">
                                                    <span class="see-preview-video font-medium font-16">{{ __('SCORM') }}</span>
                                                    <span class="video-time-count">{{ $lecture->file_duration }}</span>
                                                </div>
                                            </a>
                                            <!-- Youtube Video Player Modal Start-->
                                            <div class="modal fade VideoTypeModal" id="newScromPlayerModal{{ $lecture->id }}" tabindex="-1" aria-hidden="true">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="customers__area bg-style mb-30">
                                                                        <div class="item-title d-flex justify-content-between">
                                                                            <h2 class="p-3">{{$lecture->title}}</h2>
                                                                        </div>
                                                    
                                                                        <!-- View Curriculum Start -->
                                                                        <div class="admin-course-watch-page-area">
                                                                            <iframe id="scorm_player" class="scorm-content" frameBorder="0" src="{{ asset("uploads/".$lecture->file_path.'/'.$lecture->url_path) }}"
