                                    ...
                                    <div class="filter-bar-left-top color-heading mb-3">
                                        ...
                                        <ul class="d-inline-flex align-items-center flex-wrap">
                                            ...
                                            @foreach(@$random_four_categories as $random_four_category)
                                                ...
                                                <li class="search-tag-list color-hover font-13 font-medium"><a href="{{ route('category-courses', strtolower($random_four_category->slug)) }}">{{ __($random_four_category->name) }}</a></li>
