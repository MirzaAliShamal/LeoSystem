...
<script>
    const sm_player = new Plyr('#player');
        const sm_player1 = new Plyr('#player1');
        const sm_player2 = new Plyr('#playerVideoYoutube');
        const sm_player3 = new Plyr('#youtubePlayer');
        const sm_player4 = new Plyr('#playerVideoVimeo');
        const sm_player5 = new Plyr('#audioplayer');
</script>
<!-- Video Player js -->
