                                ...
                                <tr>
                                    <td>
                                        <div class="all-student-img-wrap">
                                            @if(file_exists(public_path(@$enrollment->user->image_path)) && @$enrollment->user->image_path)
                                                <img src="{{  asset(@$enrollment->user->image_path) }}" alt="img" class="img-fluid">
                                            @elseif(file_exists(public_path('uploads/user/'.@$enrollment->user->image_path)) && @$enrollment->user->image_path)
                                                <img src="{{  asset('uploads/user/'.@$enrollment->user->image_path) }}" alt="img" class="img-fluid">
                                            @else
                                                <img src="{{  asset('frontend/assets/img/no-image.png') }}" alt="img" class="img-fluid">
                                            @endif
                                        </div>
                                    </td>
