                                ...
                                <div class="recently-added-course-item d-flex align-items-center">
                                    <div class="recently-added-course-item-left flex-shrink-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0" style="width: 20%;border-radius: 33px;"
{{--                                                 style="--}}
{{--                                            background-image:url({{getImageFile($recentCourse->catalogue_image)}});--}}
{{--                                            background-size: cover;height: 100px;background-repeat: no-repeat;padding: 70px 50px 39px;border-radius: 33px;width: 100%;"--}}
                                            >
                                                <img src="{{getImageFile($recentCourse->catalogue_image)}}" class="img-fluid" width="100%" height="100%" alt="img">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="font-15">{{ Str::limit($recentCourse->title, 15) }}</h6>
                                                <p class="font-14">{{ courseStudents($recentCourse->id) }} {{__('Enroll')}} </p>
                                                <div class="recently-added-course-item-right flex-grow-1 justify-content-end text-start mt-1">
