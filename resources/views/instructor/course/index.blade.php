            ...
            <div class="row">
                ...
                @forelse($courses as $course)
                    ...
                    <div class="col-12 col-sm-6 col-lg-12">
                        <div class="card course-item gap-3` instructor-my-course-item bg-white p-1">
                            <div class="course-img-wrap flex-shrink-0 overflow-hidden p-0">
                                ...
                                <!--<a href="#"><img src="{{ asset('uploads/' . $course->image_path) }}" alt="course" class="img-fluid"></a>-->
                                {{-- Check if the image file exists --}}
                                <!--@if (file_exists(public_path('uploads/' . $course->image_path)))-->
                                <!--    <a href="#"><img src="{{ asset('uploads/' . $course->image_path) }}" alt="course" class="img-fluid"></a>-->
                                <!--@else-->
                                <!--    {{-- Fallback to using getImageFile --}}-->
                                <!--    @if (function_exists('getImageFile') && $imagePath = getImageFile($course->image_path))-->
                                <!--        <a href="#"><img src="{{ $imagePath }}" alt="course" class="img-fluid"></a>-->
                                <!--    @else-->
                                <!--        {{-- Fallback to using asset function --}}-->
                                <!--        <a href="#"><img src="{{ asset('uploads/' . $course->image_path) }}" alt="course" class="img-fluid"></a>-->
                                <!--    @endif-->
                                <!--@endif-->
                                @php
                                ...
                                @if (file_exists($filePath) && $course->catalogue_image)
                                    <a href="#"><img src="{{ asset($imagePath) }}" alt="Course Image" class="img-fluid"></a>
                                @else
                                    {{-- Fallback to using getImageFile --}}
                                    @if (function_exists('getImageFile') && $courseImagePath = getImageFile($course->catalogue_image))
                                        <a href="#"><img src="{{ $courseImagePath }}" alt="Course Image"
                                                         class="img-fluid"></a>
                                    @else
                                        {{-- Fallback to using asset function --}}
                                        <a href="#"><img src="{{ asset('/uploads/default/course.jpg') }}"
                                                         alt="Default Course Image" class="img-fluid"></a>
                                    @endif
                                @endif
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="instructor-my-course-item-left">
                                    <h5 class="card-title course-title" style="height: auto;"><a
                                    ...
                                    <div class="course-item-bottom">
                                        ...
                                        <div class="instructor-my-courses-btns d-inline-flex">
                                            ...
                                            @if ($course->status == 2)
                                            <a href="{{route('instructor.course.edit', [$course->uuid])}}" style="color: #bcbbbb; pointer-events: none;cursor: not-allowed !important;"
                                                class="cursor-not-allowed font-14 font-medium d-flex align-items-center"><span
                                                         class="iconify cursor-default"
                                                         data-icon="bx:bx-edit"></span>{{ __('Edit') }}</a>
                                            @else
                                            ...
                                            @endif
                                                ...
                                                @if($course->user_id == auth()->id())
                                                    <button class="para-color font-14 font-medium d-flex align-items-center deleteItem"
                                            ...
                                            @else
                                                <span class="para-color font-14 font-medium d-flex align-items-center">
                                                    @if (!is_null($course->organization))
                                                        ...
                                                        : {{ $course->organization->first_name }} {{ $course->organization->last_name }}
