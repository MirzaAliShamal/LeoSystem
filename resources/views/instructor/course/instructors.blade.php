                    ...
                    <div id="msform">
                        ...
                        <form method="POST" action="{{route('course.store.instructor', [$course->uuid])}}"
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div class="row" >
                                    <div class="col-md-12">
                                        <p class="text-dark text-center  mt-3 mb-3" style="font-weight:600;font-family: 'Roboto', 'Helvetica Neue', Arial, sans-serif">Collaboration With Professional Teachers And Organizations</p>
                                        <div class="border text-center "style="border-radius:20px">
                     <pre class="mt-4" style="font-weight:600; font-size: 16px;color:#000000;font-family: 'Roboto', 'Helvetica Neue', Arial, sans-serif">At this Moment in Time, Your Status and Rating Do Not Allow You to Begin Mutually
 Beneficial Cooperation with Other Professional Teachers and Organizations in Our
         LeoSystem Educational Community.

     We Always Wish You Favorable Development and Better Prospects!
