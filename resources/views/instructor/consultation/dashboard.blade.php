        ...
        <div class="instructor-quiz-list-page instructor-consultation-page">
            ...
            <div class="are-you-available-box mb-30">
                <form action="{{ route('instructor.consultation.instructorAvailabilityStoreUpdate') }}" method="post">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if($instructor->free_trail == 1) checked @endif type="radio" id="free-trail-yes" value="1"
                                   name="free_trail">
                            <label class="form-check-label color-heading mb-0" for="free-trail-yes">{{ __('Yes') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if($instructor->free_trail != 1) checked @endif type="radio" id="free-trail-no" value="0"
                                   name="free_trail">
