    ...
    <nav class="account-page-menu">
        <ul>
            ...
            <li class="menu-has-children current-menu-item {{@$navProfileActiveClass}}">
                ...
                <ul class="account-sub-menu">
                    <li><a href="{{ route('instructor.profile',['id' => auth()->id(),'name' => auth()->user()->instructor->full_instructor_name_slug]) }}" class="{{ @$subNavProfileBasicActiveClass }}">{{__('Basic Information')}}</a></li>
