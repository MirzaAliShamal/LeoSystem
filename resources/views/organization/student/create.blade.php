...
{{--                            <img src="" class="custom_border">--}}
                            <img src="{{ asset('uploads/default/reg-default-student.jpg') }}" alt="User Image" class="custom_border" id="circle">
                            <input type="file" id="fileuplode" name="image" class="image" accept="image/png, image/jpg, image/jpeg">
                    ...
                    <div class="col-md-8 mb-30 my-auto">
                        @if ($errors->has('image'))
                ...
                img.onload = function () {
                    if ((img.width > 5000 || img.width < 700) && (img.height > 5000 || img.height < 700)) {
                        Swal.fire({
                            ...
                            html: "<p class='font-bold'><i>Thank You for the Image Uploading!</i></p><p class='text-xs text-danger font-bold'>Approved Minimum Image Size: 700 x 700 px!</p><p class='text-xs text-danger font-bold'>Approved Maximum Image Size: 5000 x 5000 px!</p><p class='font-bold'><i>Best Regards!</i></p>",
                        });
                    }else {
                        $modal.modal('show');
                    }
