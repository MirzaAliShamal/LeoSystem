            ...
            <div class="instructor-profile-info-box">
                ...
                <div class="row">
                    <div class="col-md-12 mb-30">
                        ...
                        <input type="text" name="address" id="location-address" value="{{ $organization->address }}" class="form-control"
    ...
    <script>
        ...
        function initAutocomplete() {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                // Loop through the address components to find the relevant data
