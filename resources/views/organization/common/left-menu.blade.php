        ...
        <ul>
           ...
           {{-- <li class="menu-has-children current-menu-item {{@$navFinanceActiveClass}}">
            ...
            <li class="menu-has-children current-menu-item {{@$navProfileActiveClass}}">
                ...
                <ul class="account-sub-menu">
                    <li><a href="{{ route('organization.profile',['id' => auth()->id(),'name' => auth()->user()->organization->full_organization_name_slug]) }}" class="{{ @$subNavProfileBasicActiveClass }}">{{__('Basic Information')}}</a></li>
