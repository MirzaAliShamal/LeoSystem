            ...
            <div class="row">
                ...
                @forelse($courses as $course)
                    ...
                    <div class="col-12 col-sm-6 col-lg-12">
                        <div class="card course-item gap-3 instructor-my-course-item bg-white p-2">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="instructor-my-course-item-left">
                                    <h5 class="card-title course-title" style="height: auto;"><a href="{{ route('course-details', $course->slug) }}">{{ Str::limit($course->title, 40) }}</a></h5>
