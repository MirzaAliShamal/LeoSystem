                ...
                <div class="row">
                    <div class="col-md-4 mb-30">
                        <div class="upload-img-box mt-3 height-200 custom_border">
                            <img src="{{ asset('uploads/default/reg-default-teacher.jpg') }}" class="custom_border" id="circle">
                            <input type="file" id="fileuplode" class="image" name="image" accept="image/png, image/jpg, image/jpeg">
