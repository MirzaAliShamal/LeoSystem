        ...
        <div class="instructor-quiz-list-page instructor-consultation-page">
            ...
            <div class="are-you-available-box mb-30">
                <form action="{{ route('organization.consultation.availabilityUpdate') }}" method="post">
                    ...
                    <h6 class="are-you-available-title mb-3 d-inline-flex align-items-center"><span class="iconify me-2" data-icon="heroicons-outline:thumb-up"></span>{{ __('Free Trail Lesson (1 Time - 30 Minutes for 1 Unique Student)') }}</h6>
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if($organization->free_trail == 1) checked @endif type="radio" id="free-trail-yes" value="1"
                                   name="free_trail">
                            <label class="form-check-label color-heading mb-0" for="free-trail-yes">{{ __('Yes') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if($organization->free_trail != 1) checked @endif type="radio" id="free-trail-no" value="0"
                                   name="free_trail">
                            <label class="form-check-label color-heading mb-0" for="free-trail-no">{{ __('No') }}</label>
                        </div>
                    </div>
